...
from app.utils.itinerary import RequestMetadata, SimpleTravelItinerary, TravelItinerary
...
class ItineraryParserTemplate:
    ...
    def __init__(self, prompt_file: str = None) -> None:
        ...
        self.system_message = SystemMessagePromptTemplate.from_template(
            self.system_instruction, partial_variables={'format_instructions': self.parser.get_format_instructions()}
        )
...
class ItineraryParserAgent:
    ...
    def parse_itinerary_output(self, request: str) -> TravelItinerary:
        ...
        try:
            ...
            metadata = RequestMetadata(original_request=request, parser_used='ai')
